...
const reconnectDelaySeconds = Math.max(Number(RECONNECT_DELAY_SECONDS || 300), 60);
const reconnectDelayMs = reconnectDelaySeconds * 1000;
...
function scheduleReconnect() {
  ...
  reconnectTimer = setTimeout(async () => {
    ...
    try {
      ...
      console.error(
        `Reconnexion impossible, nouvel essai dans ${reconnectDelaySeconds} secondes:`,
        error.message
      );
      scheduleReconnect();
    } finally {
